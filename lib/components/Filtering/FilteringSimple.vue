<template>
  <div class="sm:mt-2 flex flex-col sm:flex-row gap-2 sm:gap-0 items-start sm:items-center"> 
    <div class="relative mr-4 flex h-8 w-full">
      <input v-model="state.filter" :placeholder="placeholder" class="og-form-input og-text-compact">
    ...
    <div class="bg-slate-200 text-white flex flex-row gap-1 w-full">
      <span class="og-text-compact">{{ helpText }}</span>
    </div>
  </div>
</template>
