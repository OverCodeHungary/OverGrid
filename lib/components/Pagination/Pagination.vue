<template>
  <div class="mt-3 w-full flex items-center justify-center">
    <ol class="flex flex-row items-center gap-3">
      <li>
        <button :disabled="isPaginationBackDisabled" @click="paginationBack" data-test="OGPaginationBack" class="disabled:opacity-50 flex h-8 w-8 items-center justify-center !rounded-full bg-slate-150 text-slate-500 transition-colors hover:bg-slate-300 focus:bg-slate-300 active:bg-slate-300/80 dark:bg-navy-500 dark:text-navy-200 dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90">
      ...
      <li>
        <button :disabled="isPaginationNextDisabled" @click="paginationNext" data-test="OGPaginationNext" class="disabled:opacity-50 flex h-8 w-8 items-center justify-center !rounded-full bg-slate-150 text-slate-500 transition-colors hover:bg-slate-300 focus:bg-slate-300 active:bg-slate-300/80 dark:bg-navy-500 dark:text-navy-200 dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90">
